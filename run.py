...
full_n=0
recover=1
distance='wasserstein_l2'



cmd = "python train.py --distance {} --bs {} --dataset {} --n_degree {} --n_epoch {} --lr {} --select {} --n_task {} --n_class {} --n_interval {} --n_mc {}".format(distance, bs, dataset,degree,
